  ...
  return (
    <div className="relative min-h-screen bg-[#07080d] text-white flex items-center justify-center px-4 py-12 overflow-hidden selection:bg-orange-500 selection:text-white font-sans">
      ...
      <div className="relative w-full max-w-md z-20">
        {/* Brand Header with zoom-in-fade animation */}
        <div className="flex flex-col items-center text-center mb-8 animate-zoom-in-fade">
        ...
        {/* Animated Neon Rotating Border Wrapper + slide-up + shake on error */}
        <div className={`relative rounded-3xl p-[1.5px] overflow-hidden group shadow-[0_25px_60px_rgba(0,0,0,0.8)] transition-all duration-300 hover:shadow-[0_30px_70px_rgba(249,115,22,0.25)] animate-slide-up-fade ${isShaking ? "animate-shake" : ""}`}>
          ...
          <div className="relative rounded-3xl bg-[#0e101a]/90 backdrop-blur-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Email Field with dynamic Floating Label */}
              <div className="relative group/input">
                <input
                  ...
                  placeholder=" "
                  required
                  className="peer w-full rounded-xl border border-white/10 bg-white/[0.04] pt-5.5 pb-2.5 px-4 pl-11 text-sm text-white placeholder-transparent outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:bg-white/[0.08] transition-all duration-300"
                />
                <label className="absolute left-11 top-1/2 -translate-y-1/2 text-xs font-semibold text-zinc-500 uppercase tracking-wider pointer-events-none transition-all duration-300 peer-placeholder-shown:text-xs peer-placeholder-shown:text-zinc-500 peer-focus:top-2.5 peer-focus:text-[9px] peer-focus:text-orange-400 peer-[:not(:placeholder-shown)]:top-2.5 peer-[:not(:placeholder-shown)]:text-[9px] peer-[:not(:placeholder-shown)]:text-zinc-500">
                  Email quản trị
                </label>
                <svg className="w-4 h-4 text-zinc-500 peer-focus:text-orange-400 peer-[:not(:placeholder-shown)]:text-zinc-400 transition-colors absolute left-4 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
              </div>

              {/* Password Field with dynamic Floating Label */}
              <div className="relative group/input">
                <input
                  ...
                  placeholder=" "
                  required
                  className="peer w-full rounded-xl border border-white/10 bg-white/[0.04] pt-5.5 pb-2.5 px-4 pl-11 pr-11 text-sm text-white placeholder-transparent outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:bg-white/[0.08] transition-all duration-300"
                />
                <label className="absolute left-11 top-1/2 -translate-y-1/2 text-xs font-semibold text-zinc-500 uppercase tracking-wider pointer-events-none transition-all duration-300 peer-placeholder-shown:text-xs peer-placeholder-shown:text-zinc-500 peer-focus:top-2.5 peer-focus:text-[9px] peer-focus:text-orange-400 peer-[:not(:placeholder-shown)]:top-2.5 peer-[:not(:placeholder-shown)]:text-[9px] peer-[:not(:placeholder-shown)]:text-zinc-500">
                  Mật khẩu
                </label>
              ...
              {/* Submit Button with Active Scale and Shimmer Effect */}
              <button
                type="submit"
                disabled={loading}
                className="relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 via-red-500 to-rose-600 hover:from-orange-400 hover:to-rose-500 text-white font-bold text-sm py-3.5 px-4 shadow-[0_0_25px_rgba(238,82,31,0.4)] hover:shadow-[0_0_40px_rgba(238,82,31,0.7)] active:scale-[0.96] disabled:opacity-50 transition-all duration-300 cursor-pointer flex items-center justify-center gap-2 group/btn before:absolute before:inset-0 before:-translate-x-full hover:before:translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:transition-transform before:duration-1000"
              >
                {loading ? (
                  <>
