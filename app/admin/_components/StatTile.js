...
export default function StatTile({ label, value, delta, deltaGood = true, icon: Icon, accent = "#2a78d6" }) {
  ...
  return (
    <div className="rounded-xl border border-black/10 bg-white p-5">
      ...
      <p className="mt-3 text-[28px] font-semibold text-[#0b0b0b] leading-none">{value}</p>
      {typeof delta === "number" && (
