...
export const sectionLabelsByLanding = {
  "/thuonghieuchuyendoi": {
    ...
    hero: "Hero — Lời hứa chính",
    benefits: "Giới thiệu giải pháp — Bạn có được gì",
    "overcome-barriers": "Giới thiệu giải pháp — Vượt qua rào cản",
    "customer-pain-points": "Vấn đề khách hàng đang gặp",
    instructor: "Người dẫn đường",
    methodology: "Tổng hợp chương trình",
    "pricing-tiers": "Lựa chọn hạng vé",
