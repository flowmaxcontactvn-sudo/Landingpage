    ...
    <div>
      ...
      >
        <div className="max-w-[800px] mx-auto px-6 max-[680px]:px-4 relative text-center flex flex-col items-center">
          ...
          <a
            href="#register"
            onClick={(e) => handleAnchorClick(e, "register")}
            className="inline-block bg-[#e30a0a] hover:bg-[#ff1e1e] text-white font-extrabold text-[15px] md:text-[16px] px-10 py-4.5 rounded-full text-center tracking-wide uppercase transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_10px_30px_rgba(227,10,10,0.4)] leading-tight font-montserrat mx-auto"
          >
        ...
        <div className={container}>
          ...
          <div className="text-center mt-12">
            <a
              href="#register"
              onClick={(e) => handleAnchorClick(e, "register")}
              className={"inline-block " + ctaButtonInline + " text-[17px] px-10 py-4.5 text-center animate-btn-pulse"}
            >
        ...
        <div className={container}>
          ...
          <div className="text-center mt-10">
            <a
              href="#register"
              onClick={(e) => handleAnchorClick(e, "register")}
              className={"inline-block " + ctaButtonInline + " text-[17px] px-10 py-4.5"}
            >
      ...
      <section className="bg-white text-center py-20 max-[680px]:py-10 border-t-[3px] border-t-[#f0f0f0]" data-section="methodology">
        <div className={container}>
          ...
          <a href="#register" onClick={(e) => handleAnchorClick(e, "register")} className={"inline-block " + ctaButtonInline + " text-[17px] px-10 py-4.5 animate-btn-pulse"}>
