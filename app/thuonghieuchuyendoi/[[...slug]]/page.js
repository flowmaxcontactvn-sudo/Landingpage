...
export default function ThuongHieuChuyenDoiPage() {
  ...
  return (
    <div>
      ...
      ══════════════════════════════════════════ */}
      <div
        className="sticky top-0 z-50 relative overflow-hidden bg-[#e30a0a] text-white text-center px-6 py-2 text-[17px] font-bold flex flex-wrap items-center justify-center gap-x-5 gap-y-1.5 max-[680px]:text-[16px] max-[680px]:py-1.5 font-montserrat shadow-md"
